...
class DefaultConvertModifierStrategyTest : public ::testing::Test
{
protected:
    DefaultConvertModifierStrategyTest() = default;

    DefaultConvertModifierStrategy convertModifierStrategy;
};

TEST_F(DefaultConvertModifierStrategyTest, Buttons)
{
    ...
    EXPECT_EQ(convertModifierStrategy.convertButtonToModifierFlags(BTN_CTRL_R_MAC_ALT_R),
              LayoutModifiersDefs::LayoutModifierFlags(LayoutModifiersDefs::Flag::CTRL_RIGHT));
