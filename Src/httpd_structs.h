...
#define HTTP_HDR_PNGZ HTTP_CONTENT_TYPE_ENCODING("image/png", "gzip")
...
#define HTTP_HDR_JSZ HTTP_CONTENT_TYPE_ENCODING("application/javascript", "gzip")
#define HTTP_HDR_RA HTTP_CONTENT_TYPE("application/javascript")
#define HTTP_HDR_CSS HTTP_CONTENT_TYPE("text/css")
#define HTTP_HDR_CSSZ HTTP_CONTENT_TYPE_ENCODING("text/css", "gzip")
...
#define HTTP_HDR_SVGZ HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
#define HTTP_HDR_OTFZ HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
#define HTTP_HDR_EOTZ HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
#define HTTP_HDR_TTFZ HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
#define HTTP_HDR_WOFFZ HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
#define HTTP_HDR_WOFF2Z HTTP_CONTENT_TYPE_ENCODING("text/plain", "gzip")
 ...
 * and subtypes) */
static const tHTTPHeader g_psHTTPHeaders[] = {{"html", HTTP_HDR_HTMLZ},
                                              {"htm", HTTP_HDR_HTMLZ},
                                              {"shtml", HTTP_HDR_SSI},
                                              {"shtm", HTTP_HDR_SSI},
                                              {"ssi", HTTP_HDR_SSI},
